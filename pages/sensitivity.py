...
from visualization.gauges import C_TEXT, C_TEXT_DIM, FONT_FAMILY
...
def layout():
    return html.Div([
        ...
        html.P("Explore how design parameters affect system performance. "
        ...
        html.Div(style={"display":"flex","gap":"20px","marginBottom":"16px",
            ...
            html.Div(style={"display":"flex","gap":"8px","alignItems":"center"}, children=[
                ...
                html.Div(style={"width":"160px",**DASH_VARS}, children=[
                    dcc.Dropdown(id="sensitivity-variation-pct",
            ...
            html.Div(style={"display":"flex","gap":"8px","alignItems":"center"}, children=[
                ...
                html.Div(style={"width":"200px",**DASH_VARS}, children=[
                    dcc.Dropdown(id="sensitivity-material-density",
                        options=[
        ...
        # Tornado
        html.Div(style={"backgroundColor":CARD_BG,"border":f"1px solid {CARD_BORDER}",
                         "borderRadius":"6px","padding":"14px","marginBottom":"14px"}, children=[
            html.H3("PARAMETER SENSITIVITY (TORNADO)", style=TITLE_STYLE),
        ...
        html.Div(style={"display":"flex","gap":"14px","flexWrap":"wrap"}, children=[
            html.Div(style={"flex":"1 1 400px","backgroundColor":CARD_BG,
                             "border":f"1px solid {CARD_BORDER}","borderRadius":"6px","padding":"14px"}, children=[
                html.H3("RADIUS vs THICKNESS TRADE-OFF", style=TITLE_STYLE),
                dcc.Loading(type="circle", color="#5BA4B5", children=[
            ...
            html.Div(style={"flex":"1 1 400px","backgroundColor":CARD_BG,
                             "border":f"1px solid {CARD_BORDER}","borderRadius":"6px","padding":"14px"}, children=[
                html.H3("FEASIBILITY ENVELOPE", style=TITLE_STYLE),
                dcc.Loading(type="circle", color="#5BA4B5", children=[
